...
setwd("C:/Users/Owner/Desktop/NEON-GLM/GLM_LIRO") # --> set the Directory to Barco Lake
...
glmcmd = 'C:/Users/Owner/Desktop/NEON-GLM/GLM_LIRO/glm' # --> Set up the GLM Command for your system
...
field_temp<-file.path('C:/Users/Owner/Desktop/NEON-GLM/observations/CleanedObsTempLIRO.csv')
