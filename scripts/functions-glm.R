...
#Last updated by Ryan McClure on 16 Nov 2020
...
run_glm <- function(os){
  if (os == "Windows"){
    ...
    sim_folder = "C:/Users/Owner/Desktop/NEON-GLM/GLM_BARC" #BE SURE TO EDIT THIS!
    system2(paste0(sim_folder, "/", "glm.exe"), stdout = TRUE, stderr = TRUE, env = paste0("DYLD_LIBRARY_PATH=",sim_folder))
  }
}
...
run_sensitivity <- function(var, max_r, x0, lb, ub, pars, obs, nml_file){
  ...
  p6 <- ggplot(morris_res, aes(pars,mean))+ #EDIT THIS- Originally I had it as (morris_res, aes(pars,mean))
...
run_calibvalid <- function(var, var_unit, var_seq, cal_pars, pars, ub, lb, init.val, 
  ...
  calibration.list <- list("start" = '2017-08-27 00:00:00',
                           "stop" = '2019-12-31 00:00:00')  #EDIT THIS!
  nml <- read_nml('glm3.nml')
  ...
  validation.list <- list("start" = '2020-01-01 00:00:00',
                          "stop" = '2020-10-01 00:00:00') # EDITED THIS
  nml <- read_nml('glm3.nml')
  ...
  total.list <- list("start" = '2017-08-27 00:00:00', "stop" = '2020-10-01 00:00:00') #EDIT THIS!
  #EDITED THIS
